...
import 'package:flutter_app_chat/screens/signin/signin_screen.dart';
import 'package:flutter_app_chat/services/auth_service.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_user != null ? (_user.displayName) : 'Loading'),
        actions: <Widget>[
          IconButton(
